 ...
 */
Ext.define("Phoenix.view.scenario.grid.ScenarioGridController", {
  extend: "Phoenix.view.AbstractPhoenixController",
  alias: "controller.ScenarioGridController",
  requires: ["Ext.data.identifier.Uuid", "Ext.MessageBox", "Phoenix.model.Scenario"],
  observe: {
    scenarioContext: {
