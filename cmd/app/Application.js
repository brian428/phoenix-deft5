...
Ext.define("Phoenix.Application", {
  ...
  requires: ["Deft.ioc.Injector", "Phoenix.config.AppConfig", "Phoenix.store.ScenarioStore", "Phoenix.service.ScenarioService", "Phoenix.context.ScenarioContext", "Phoenix.store.ProbabilityStore", "Phoenix.store.RevenueImpactStore", "Phoenix.store.AffectedItemStore", "Phoenix.service.NotificationService", "Phoenix.view.Viewport"],
  name: "Phoenix",
  controllers: ["Root"],
  stores: [],
  views: [],
